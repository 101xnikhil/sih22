      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-4 gap-4 min-h-0">
        ...
        <div className="lg:col-span-3 relative rounded-2xl overflow-hidden border border-[#e5e9f2] dark:border-white/10 shadow-sm h-full flex flex-col bg-white dark:bg-[#0f172a]">
            ...
            <Marker position={position} icon={getMarkerIcon()}>
              <Popup>
                <div className="p-1 text-slate-900 dark:text-slate-100 font-sans min-w-[180px]">
                  ...
                  <div className="text-[10px] text-slate-600 dark:text-slate-400 mb-2">{node.location.description}</div>
          ...
          <div className="absolute bottom-4 right-4 z-[1000] bg-white/95 dark:bg-[#0f172a]/95 backdrop-blur-xs border border-slate-200 dark:border-white/10 rounded-xl p-3 shadow-lg font-sans text-xs">
            <h4 className="text-[10px] font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-2">
              Hazard Tier Legend
            </h4>
            <div className="space-y-1 text-[11px] font-medium">
              <div className="flex items-center gap-2">
                <div className="w-2.5 h-2.5 rounded-full bg-[#10b981]" />
                <span className="text-slate-700 dark:text-slate-300">LOW (0.00 – 0.25)</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2.5 h-2.5 rounded-full bg-[#f59e0b]" />
                <span className="text-slate-700 dark:text-slate-300">MODERATE (0.25 – 0.50)</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2.5 h-2.5 rounded-full bg-[#f97316]" />
                <span className="text-slate-700 dark:text-slate-300">HIGH (0.50 – 0.75)</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2.5 h-2.5 rounded-full bg-[#ef4444]" />
                <span className="text-slate-700 dark:text-slate-300">CRITICAL (0.75 – 1.00)</span>
              </div>
            </div>
          </div>

          {/* Map Floating Coordinates Tag */}
          <div className="absolute top-4 left-4 z-[1000] bg-white/95 dark:bg-[#0f172a]/95 border border-slate-200 dark:border-white/10 rounded-xl px-3 py-2 shadow-md text-xs text-slate-700 dark:text-slate-300 font-sans">
            ...
            <div className="text-slate-500 dark:text-slate-400 text-[11px]">Elevation: {node.location.altitude_m}m ASL · Sector 7</div>
          </div>
        </div>
            ...
            <div className="card-body p-4 space-y-4 text-xs">
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-100 dark:border-white/10">
                ...
                <div className="flex items-baseline justify-between mt-1 font-mono">
                  ...
                  <span className="text-slate-500 dark:text-slate-400 text-xs font-sans">FoS: <strong className="text-slate-800 dark:text-slate-200 font-mono">{currentRisk.fos_estimate.toFixed(2)}</strong></span>
                </div>
              </div>
